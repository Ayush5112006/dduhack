...
// Organizer profile mirrors the participant profile but keeps the organizer sidebar
// and uses the same /api/profile backend so data stays in the role-specific DB.
type Profile = {
  avatar?: string
  bio?: string
  location?: string
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="px-4 py-6 lg:ml-64 lg:p-8 max-w-6xl mx-auto">
        <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h1 className="text-3xl font-bold text-foreground">Organizer Profile</h1>
            ...
            <Card className="border-border bg-card">
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">Hackathons Hosted/Participated</div>
                </div>
                <div>
