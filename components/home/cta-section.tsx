          ...
          <div className="relative mx-auto max-w-2xl text-center">
            ...
            <div className="mt-6 sm:mt-8 flex flex-col justify-center gap-3 sm:gap-4 sm:flex-row px-2">
              <Link href="/hackathons" className="w-full sm:w-auto">
                <Button size="lg" className="gap-2 h-12 w-full sm:w-auto touch-manipulation">
                  Browse Hackathons <ArrowRight className="h-4 w-4" />
                </Button>
              </Link>
              <Link href="/organizer/dashboard" className="w-full sm:w-auto">
                <Button size="lg" variant="outline" className="h-12 w-full sm:w-auto touch-manipulation">
                  Host a Hackathon
                </Button>
              </Link>
            </div>
